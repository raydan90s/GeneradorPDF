...
// Type: Yachasoft.Sri.Xsd.Contratos.GuiaRemision_1_0_0.guiaRemision
...
namespace Yachasoft.Sri.Xsd.Contratos.GuiaRemision_1_0_0
{
  ...
  public class guiaRemision
  {
    ...
    {
      get => this.infoGuiaRemisionField;
      set => this.infoGuiaRemisionField = value;
    }

    public guiaRemisionDestinatarios destinatarios
    {
      get => this.destinatariosField;
      set => this.destinatariosField = value;
    }
