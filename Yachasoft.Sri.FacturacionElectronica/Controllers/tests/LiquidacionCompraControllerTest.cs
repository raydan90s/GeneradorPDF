...
namespace Yachasoft.Sri.FacturacionElectronica.Controllers
{
    ...
    [ApiController]
    public class LiquidacionControllerTest : ControllerBase
    {
        ...
        public LiquidacionControllerTest(
       ...
       public async Task<IActionResult> GenerarLiquidacion()
{
    try
    {
        ...
        var emisor = new Emisor
        {
            ...
            Logo = @"C:\Users\Sistemas\Documents\GeneradorPDF\Yachasoft.Sri.FacturacionElectronica\Logo_UTPL.png",
        ...
        // 4️⃣ Firmar
        certificadoService.CargarDesdeP12(@"C:\Users\Sistemas\Downloads\FIRMA\signature.p12", "Compus1234");
        ...
        rIDEService.LiquidacionCompra_1_0_0(
            liquidacion,
            @"C:\Users\Sistemas\Desktop\LIQUIDACION.pdf"
        );
